...
export default function NewDeclarationPage() {
  const { user } = useAuth()
  const { addDeclaration } = useData()
  const router = useRouter()
  const [isSubmitting, setIsSubmitting] = useState(false)

  const [formData, setFormData] = useState({
    type: "temporary_residence" as "temporary_residence" | "temporary_absence",
    startDate: "",
    endDate: "",
    reason: "",
    personName: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    addDeclaration({
      ...
      personIdCard: formData.personIdCard,
    ...
    router.push("/resident/declarations")
  }
